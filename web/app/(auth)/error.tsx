      ...
      <div className="max-w-md w-full bg-surface-raised rounded-xl p-6 border border-border">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex-1 px-4 py-2 text-sm font-medium text-text-primary bg-surface-raised border border-border-light rounded-lg hover:bg-surface transition-colors"
          >
            Back to login
          </button>
        </div>
